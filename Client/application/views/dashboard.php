...
<html lang="en">
  ...
  <div class="container-fluid">
    <div class="owl-banner owl-carousel">
      <div class="item">
        <img src="<?= base_url('assets/assets_shop') ?>/images/kamar1.jpg" alt="" width="500" height="350">
      ...
      <div class="item">
        <img src="<?= base_url('assets/assets_shop') ?>/images/kamar5.jpg" alt="" width="500" height="350">
        <div class="item-content">
          <div class="main-content">
      ...
      <div class="item">
        <img src="<?= base_url('assets/assets_shop') ?>/images/kamar3.jpg" alt="" width="500" height="350">
        <div class="item-content">
          <div class="main-content">
      ...
      <div class="item">
        <img src="<?= base_url('assets/assets_shop') ?>/images/kamar4.jpg" alt="" width="500" height="350">
        <div class="item-content">
          <div class="main-content">
         ...
         <div class="footer">
            <div class="container">
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <div class="cont">
                        <h3>Kost Tegar </h3>
                        <p>Jalan Cengkeh, Gedung Meneng, Rajabasa</p>
                     </div>
                  </div>
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>Copyright 2022 All Right Reserved By <a href=""> Kost Tegar</a></p>
                     </div>
                  </div>
               </div>
            </div>
